...
class A_NextGen_Pro_Film_Controller extends Mixin
{
    ...
    function index_action($displayed_gallery, $return = FALSE)
    {
        ...
        $params = array('effect_code' => $this->object->get_effect_code($displayed_gallery), 'id' => $id, 'images' => $images, 'pagination' => $pagination, 'storage' => C_Gallery_Storage::get_instance(), 'thumbnail_size_name' => $thumbnail_size_name);
    ...
    function enqueue_frontend_resources($displayed_gallery)
    {
        ...
        $controller = C_Dynamic_Stylesheet_Controller::get_instance('all');
        $controller->register('nextgen_pro_film', 'photocrati-nextgen_pro_film#nextgen_pro_film_dyncss');
