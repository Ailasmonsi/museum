      ...
      <div class="wrapper">
        <div class="breadcrumb">
          <ul class="bc-list">
            ...
            <li class="bc-item">
              <a href="/history" class="bc-link">Исторический блок</a>
            </li>
          </ul>
        </div>
        <h2 class="title">Исторический блок</h2>
      </div>
      <nav>
        <div class="wrapper">
          <ul class="page-list">
            <li class="page-item">
              <button class="page-btn selected">Хроника жизни
                П.С. Нахимова</button>
            </li>
            <!-- <li class="page-item">
                            <button class="page-btn ">Синопское сражение</button>
                        </li>
                        <li class="page-item">
                            <button class="page-btn ">Героическая оборона
                                Севастополя (1854—1855)</button>
                        </li>
                        <li class="page-item">
                            <button class="page-btn ">Репрессии на флоте.
                                Возвращение имен
                            </button>
                        </li> -->
          </ul>
