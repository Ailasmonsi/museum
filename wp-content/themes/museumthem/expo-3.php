    ...
    <section class="expo">
      <div class="wrapper">
        ...
        <nav>
          <ul class="menu-list">
            <li class="menu-item">
              <a href="/expo-1" class="menu-btn">Первый зал</a>
            </li>
            <li class="menu-item">
              <a href="/expo-2" class="menu-btn ">Второй зал</a>
            </li>
            <li class="menu-item">
              <a href="/expo-3" class="menu-btn now">Третий зал</a>
            </li>
            <li class="menu-item">
              <a href="/expo-4" class="menu-btn">Четвертый зал</a>
            </li>
            <li class="menu-item">
              <a href="/expo-5" class="menu-btn">Пятый зал</a>
            </li>
            <li class="menu-item">
              <a href="/expo-6" class="menu-btn">Шестой зал</a>
            </li>
          </ul>
        </nav>
